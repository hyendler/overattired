...
Product.delete_all
User.delete_all
UserMeasurement.delete_all
ProductMeasurement.delete_all
...
# ProductMeasurement.create(measurable_type: Product, measurable_id: 1, gender: "female", hips: 41, waist: 29, bust: 38)
# Jacket
# Bust: 38
# Waist: 29
# Overall Length: 23
